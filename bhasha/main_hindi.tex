...
\input{hindi/chapters/nomen.tex}
\section{बिंदु एवं सदिश}
\input{hindi/chapters/chapter.tex}
...
%\item सारणी \ref{table:counter_decoder} में एक परवर्ती गूढ़वाचक के गुणधर्म का उल्लेख है।  बूलीय समीकरणों के द्वारा $A,B,C,D$ को $W,X,Y,Z$ के व्यञ्जकों में व्यक्त करें।  इसके पश्चात वामन के द्वारा परवर्ती गूढ़वाचक को कार्यान्वयित करें। 
%\label{prob:counter_decoder}
%\begin{table}
%\centering
%\input{./tables/counter_decoder.tex}
%\caption{परवर्ती गूढ़वाचक की सत्य सारिणी ।}
...
%\end{figure}
%\item पूर्ववतरी गूढ़वाचक की अभिकल्पना एवं कार्यान्वयन करें।
%
%\end{enumerate}
%
